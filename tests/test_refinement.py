...
def test_refine_hbonds_1():
    ...
    hbond_1 = H_Bond(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1'), Atom(unique_id='ligand|UNL|A|1|2')],
        receptor=[Atom(unique_id='receptor|SER|A|1|OG')],
    ...
    hbond_2 = H_Bond(
        ligand=[Atom(unique_id='ligand|UNL|A|1|5'), Atom(unique_id='ligand|UNL|A|1|6')],
        receptor=[Atom(unique_id='receptor|SER|A|1|OG')],
        distance_ah=0.,  # not used
        distance_ad=3.5,
        angle_dha=150,
...
def test_refine_hbonds_2():
    ...
    hbond_2 = H_Bond(
        ligand=[Atom(unique_id='ligand|UNL|A|1|11'), Atom(unique_id='ligand|UNL|A|1|12')],
        receptor=[Atom(unique_id='receptor|SER|A|1|OG')],
        distance_ah=0.,  # not used
        distance_ad=3.0,
        angle_dha=150,
...
def test_refine_hbonds_3():
    ...
    hbond_1 = H_Bond(
        ...
        receptor=[Atom(unique_id='receptor|SER|A|1|OG'), Atom(unique_id='receptor|SER|A|1|HG')],
        distance_ah=0.,  # not used
        distance_ad=3.5,
        angle_dha=150,
        type='strong',
    ...
    hbond_2 = H_Bond(
        ligand=[Atom(unique_id='ligand|UNL|A|1|11')],
        receptor=[Atom(unique_id='receptor|SER|A|1|OG'), Atom(unique_id='receptor|SER|A|1|HG')],
...
def test_refine_hbonds_4():
    ...
    hbond_2 = H_Bond(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|TYR|A|5|N'), Atom(unique_id='receptor|TYR|A|5|NH')],
        distance_ah=0.,  # not used
        distance_ad=3.4,
        angle_dha=160,
        type='strong',
...
def test_refine_hbonds_5():
    ...
    hbond_2 = H_Bond(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1'), Atom(unique_id='ligand|UNL|A|1|2')],
        receptor=[Atom(unique_id='receptor|TYR|A|5|N')],
        distance_ah=0.,  # not used
        distance_ad=3.4,
        angle_dha=160,
        type='strong',
...
def test_refine_hydrophobics_1():
    ...
    hydroph_1 = Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|LEU|A|1|CD1')],
        distance=3.8,
    )
    hydroph_2 = Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|6')],
        receptor=[Atom(unique_id='receptor|VAL|A|5|CG1')],
        distance=3.4,
    )
...
def test_refine_hydrophobics_5():
    ...
    hydroph = Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|PHE|A|1|CD1')],
        distance=3.8,
    )
    pi_stacking = Pi_Stacking(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|PHE|A|1|CD1'), Atom(unique_id='receptor|PHE|A|1|CE1')],
        distance=3.5,
        offset=0.,  # not used
        angle=0.,  # not used
        type='',  # not used
...
def test_refine_pi_cations_1():
    ...
    pi_cation_1 = Pi_Cation(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|HIS|A|9|CE1')],
        distance=4.0,
        offset=0.,  # not used
    )
    pi_cation_2 = Pi_Cation(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|PHE|A|9|CE1')],
        distance=4.0,
        offset=0.,  # not used
    )
...
def test_refine_pi_cations_2():
    ...
    pi_stacking = Pi_Stacking(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|HIS|A|9|CE1'), Atom(unique_id='receptor|HIS|A|9|ND1')],
        distance=4.0,
        offset=0.,  # not used
        angle=0.,  # not used
        type='',  # not used
...
def test_refine_pi_hydrophobics_1():
    ...
    pi_hydroph_1 = Pi_Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1', residue_id='UNL|A|1')],
        receptor=[Atom(unique_id='receptor|LEU|A|1|CD1', residue_id='LEU|A|1')],
        distance=3.5,
        offset=10.,  # used here!
    )
    pi_hydroph_2 = Pi_Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|5', residue_id='UNL|A|1')],
        receptor=[Atom(unique_id='receptor|LEU|A|3|CG', residue_id='LEU|A|3')],
        distance=4.0,
        offset=30.,  # used here!
    )
...
def test_refine_pi_hydrophobics_2():
    ...
    pi_hydroph_2 = Pi_Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1', residue_id='UNL|A|1')],
        receptor=[Atom(unique_id='receptor|LEU|A|1|CG', residue_id='LEU|A|1')],
        distance=4.0,
        offset=30.,  # used here!
    )
    selection = refine_pi_hydrophobics([pi_hydroph_1, pi_hydroph_2])
...
def test_refine_pi_hydrophobics_3():
    ...
    pi_hydroph_2 = Pi_Hydrophobic(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1', residue_id='UNL|A|1')],
        receptor=[Atom(unique_id='receptor|LEU|A|5|CG', residue_id='LEU|A|5')],
        distance=4.0,
        offset=30.,  # used here!
    )
    selection = refine_pi_hydrophobics([pi_hydroph_1, pi_hydroph_2])
...
def test_refine_water_bridges_1():
    ...
    water_bridge = Water_Bridge(
        ligand=[Atom(unique_id='ligand|UNL|A|1|1')],
        receptor=[Atom(unique_id='receptor|LEU|A|1|O')],
